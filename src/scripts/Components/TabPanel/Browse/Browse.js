...
class Browse extends React.Component {
  ...
  render() {
    if (
      !this.props.contentTypes.libraries ||
      !this.props.contentTypes.libraries.length
    ) {
      ...
      <div className="content-type-section-view loaded">
        ...
        <div
          className={
            ...
            (this.state.warnOutdated ? ' height-limit' : '') +
            (this.state.filterOn ? ' filtering' : '')
          }
        >
          <Order
            ...
            hasRecentlyUsed={
              !!(
                this.props.contentTypes.recentlyUsed &&
                this.props.contentTypes.recentlyUsed.length
              )
            }
