...
class ContentType extends React.Component {
  ...
  handleInstall = () => {
    ...
    fetchJSON(
      this.props.getAjaxUrl('library-install', {
        id: this.props.library.machineName,
      }),
      ''
    )
      .then(response => {
        ...
        const installMessageKey = this.props.installed
  ...
  render() {
    const classNames =
      'content-type-detail' + (this.state.visible ? ' show' : '');
    ...
    if (!this.props.library) {
      return <div className={classNames} id="content-type-detail" />;
    }
      ...
      >
        ...
        <div className="container">
          ...
          <div className="text-details">
            <h2 id="{titleId}" className="title" tabIndex="-1">
              {this.props.library.title || this.props.library.machineName}
            </h2>
            <div className="owner">{this.props.library.owner}</div>
            <ReadMore text={this.props.library.description} maxLength={285} />
            <a
